...
//  MyMovieApp
//
//  Created by Macbook on 13/5/24.
//

import UIKit

protocol LangugeSelectionDelegate: AnyObject {
...
final class LanguageController: UIViewController {
    ...
    //MARK: - DELEGATE
    weak var delegate: LangugeSelectionDelegate?
    ...
    private func englishLanguageChosen() {
        self.delegate?.didSelectLanguage("You just set English language")
        self.navigationController?.popViewController(animated: true)
        print("Choosen English language")
    }
    
    private func russianLanguageChosen() {
        self.delegate?.didSelectLanguage("You just set Russian language")
        self.navigationController?.popViewController(animated: true)
        print("Choosen Russian language")
    }
